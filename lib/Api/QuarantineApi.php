...
class QuarantineApi
{
     ...
     *
     * @param  \MailCow\Models\DeleteQitemBody $body body (optional)
     *
     * @throws \MailCow\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailCow\Models\InlineResponse200
     */
    public function deleteMailsInQuarantine($body = null)
    {
        list($response) = $this->deleteMailsInQuarantineWithHttpInfo($body);
        return $response;
    }
     ...
     * Delete mails in Quarantine
     *
     * @param  \MailCow\Models\DeleteQitemBody $body (optional)
     *
     * @throws \MailCow\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailCow\Models\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteMailsInQuarantineWithHttpInfo($body = null)
    {
        $returnType = '\MailCow\Models\InlineResponse200';
        $request = $this->deleteMailsInQuarantineRequest($body);
     ...
     */
    public function deleteMailsInQuarantineAsync($body = null)
    {
        return $this->deleteMailsInQuarantineAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteMailsInQuarantineAsyncWithHttpInfo($body = null)
    {
        $returnType = '\MailCow\Models\InlineResponse200';
        $request = $this->deleteMailsInQuarantineRequest($body);
     ...
     */
    protected function deleteMailsInQuarantineRequest($body = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMailsInQuarantineRequest()
    {
